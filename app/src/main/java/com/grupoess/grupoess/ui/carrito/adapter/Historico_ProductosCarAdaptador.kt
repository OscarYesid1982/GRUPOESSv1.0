...
class Historico_ProductosCarAdaptador(val datos: ArrayList<HistoricoCompras_Categorias_object>, val context: Context)
    : RecyclerView.Adapter<Historico_ProductosCarAdaptador.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.precio.text = "$ " + (datos.get(position).precion.toString().toInt() *
