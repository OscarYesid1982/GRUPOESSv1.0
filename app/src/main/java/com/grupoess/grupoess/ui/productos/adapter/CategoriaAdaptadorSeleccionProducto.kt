...
class CategoriaAdaptadorSeleccionProducto(val datos: ArrayList<Categorias_object>, val context:Context) : RecyclerView.Adapter<CategoriaAdaptadorSeleccionProducto.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view:View = LayoutInflater.from(parent.context).inflate(R.layout.item_categorias_seleccion_producto, parent, false);
        return ViewHolder(view)
    }

    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){

        val nombre: TextView = itemView.findViewById(R.id.NombreProducto_seleccionProducto)
        val contenedor: androidx.cardview.widget.CardView = itemView.findViewById(R.id.item_linear_categoria_seleccion_producto)
    }
}
